...
def setUp(self):
    ...
    """
    self.new_user = User('Perry','Slime')

def test_init(self):
    """
    a test to confirm whether the object is working correctly
    """
    self.assertEqual(self.new_user.username,'perry')
    self.assertEqual(self.new_user.password,'slime')
...
def setUp(self):
    ...
    """
    self.new_credential= Credentials('Gmail', 'perry', 'slime')
...
def test_init(self):
    ...
    self.assertEqual(self.new_credential.username,'Perry')
    self.assertEqual(self.new_credential.passwword,'slime')
...
def test_save_many_accounts(self):
    ...
    test_credentials = Credentials('Gmail', 'Kentrell','deshaun')
...
def test_delete_credential(self):
    ...
    test_credential = Credentials('Gmail', 'Kentrell', 'deshaun')
...
def test_find_credential(self):
    ...
    """
    self.new_credential.save_details()
    test_credential = Credentials('Gmail', 'Kenterll', 'deshaun')
    test_credential.save_details
...
def test_credential_exist(self):
    ...
    """    
    self.new_credential.save_details()
    the_credential = Credentials('Gmail', 'Kentrell', 'deshaun')
